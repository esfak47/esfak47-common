 ...
 * 5</a>
 * @see com.esfak47.common.extension.SPI
 * @see com.esfak47.common.extension.Adaptive
 * @see com.esfak47.common.extension.Activate
 */
public class ExtensionLoader<T> {
    ...
    private static final String EXTEND_DIRECTORY = "META-INF/extend/";

    private static final String EXTEND_INTERNAL_DIRECTORY = EXTEND_DIRECTORY + "internal/";
    ...
    private Map<String, Class<?>> loadExtensionClasses() {
        ...
        loadDirectory(extensionClasses, EXTEND_INTERNAL_DIRECTORY);
        loadDirectory(extensionClasses, EXTEND_DIRECTORY);
            ...
            if (names != null && names.length > 0) {
                ...
                for (String n : names) {
                    ...
                    if (c == null) {
                        ...
                        throw new IllegalStateException(
                            "Duplicate extension " + type.getName() + " name " + n + " on " + c.getName() + " and "
                                + clazz.getName());
                    }
                }
            }
    ...
    private String createAdaptiveExtensionClassCode() {
        ...
        for (Method method : methods) {
            ...
            if (adaptiveAnnotation == null) {
                ...
                // check extName == null?
                String s = String.format("\nif(extName == null) " +
                        "throw new IllegalStateException(\"Fail to get extension(%s) name from url(\" + url.toString"
                        + "() + \") use keys(%s)\");",
