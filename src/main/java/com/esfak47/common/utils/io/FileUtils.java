package com.esfak47.common.utils.io;

import com.esfak47.common.utils.io.ArrayUtils;
import com.esfak47.common.utils.system.SystemUtils;
    ...
    public static void unzip(String zipPath, String toPath, String... unzipFile) throws IOException {
        try (ZipInputStream zipInputStream = new ZipInputStream(new FileInputStream(zipPath))) {
            ...
            while ((entry = zipInputStream.getNextEntry()) != null) {
                ...
                if (entry.isDirectory() || (!ArrayUtils.isEmpty(unzipFile)
                        && Arrays.stream(unzipFile)
                        .noneMatch(entryName::equalsIgnoreCase))) {
